...
response = urlopen("http://www.mit.edu/~ecprice/wordlist.10000")
...
def chunk_download(readdata=0):
  ...
  if not current_data:
    ...
    text.insert('1.0',current_data)
    master.after(5,chunk_download,readdata + len(current_data))
...
command=lambda : master.after(0,chunk_download()))
button.pack()
